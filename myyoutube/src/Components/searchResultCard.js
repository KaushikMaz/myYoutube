...
const SearchResultCard=({info})=>{
  ...
  return(
    <div className="md:p-2 md:flex cursor-pointer rounded-md">
        <img className="rounded-lg w-screen md:w-[25%]" alt= "Thumbnail" src={thumbnails.medium.url}/>
        <div className="bg-slate-100 mb-2 md:mb-0 p-1 rounded-lg md:ml-2 md:w-[75%]">
